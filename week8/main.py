...
#ShowPlot(u_list)
%timeit plainPython_result=solver(u_list,f_list,col,row,t0=0,t1=1000,dt=.1,nu=1)
...
#ShowPlot(u_numpy)
%timeit Cython_result=solver_cython(u_numpy,f_numpy,col,row,t0=0,t1=1000,dt=.1,nu=1)
#ShowPlot(Cython_result)

u_numpy=array(zeros((col,row),dtype='double'))
f_numpy=array(ones((col,row),dtype='double'))
#ShowPlot(u_numpy)
%timeit Numpy_result=solver_numpy(u_numpy,f_numpy,col,row,t0=0,t1=1000,dt=.1,nu=1)
#ShowPlot(Numpy_result)

u_numpy=array(zeros((col,row),dtype='double'))
f_numpy=array(ones((col,row),dtype='double'))
#ShowPlot(u_numpy)
%timeit Swig_result=solver_swig(u_numpy,f_numpy,col,row,t0=0,t1=1000,dt=.1,nu=1)
#ShowPlot(Swig_result)

u_numpy=array(zeros((col,row),dtype='double'))
f_numpy=array(ones((col,row),dtype='double'))
#ShowPlot(u_numpy)
%timeit Instant_result=solver_instant(u_numpy,f_numpy,col,row,t0=0,t1=1000,dt=.1,nu=1)
